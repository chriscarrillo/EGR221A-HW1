...
public class TestString {
    ...
    public static void testWithArray(Scanner input) {
        ...
        for (int i = 0; i < cases; i++) {
            ...
            System.out.println("Testing KPGuitarString with this array:");
            System.out.println(Arrays.toString(data));
            GuitarString g = new KPGuitarString(data);
    ...
    public static void testWithFrequency(Scanner input) {
        ...
        for (int i = 0; i < cases; i++) {
            ...
            int size = input.nextInt();
            System.out.println("Testing KPGuitarString with frequency " + freq);
            GuitarString g = new KPGuitarString(freq);
            g.pluck();
            double sum1 = 0.0;
